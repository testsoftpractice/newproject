        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-3 sm:py-4">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-0">
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-xl sm:text-2xl font-bold truncate">University Settings</h1>
            </div>
            ...
            <TabsContent value="preferences" className="space-y-6 mt-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Customize university dashboard settings</CardDescription>
                </CardHeader>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Make university stats publicly accessible
                      </p>
                    </div>
                    <Switch
                      id="publicDashboard"
                      checked={preferences.publicDashboard}
                      onCheckedChange={(checked) =>
                        setPreferences({ ...preferences, publicDashboard: checked })
                      }
                    />
                  </div>
                </CardContent>
            ...
            <TabsContent value="notifications" className="space-y-6 mt-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Control university notifications</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <Label htmlFor="studentAlerts">Student Activity Alerts</Label>
                      <p className="text-sm text-muted-foreground">
                        Get notified about student milestones
                      </p>
                    </div>
                    <Switch
                      id="studentAlerts"
                      checked={preferences.studentAlerts}
                      onCheckedChange={(checked) =>
                        setPreferences({ ...preferences, studentAlerts: checked })
                      }
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <Label htmlFor="projectAlerts">Project Alerts</Label>
                      <p className="text-sm text-muted-foreground">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(checked) =>
                        setPreferences({ ...preferences, projectAlerts: checked })
                      }
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Weekly summary of university activities
                      </p>
                    </div>
                    <Switch
                      id="weeklyReport"
            ...
            <TabsContent value="security" className="space-y-6 mt-6">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Manage university account</CardDescription>
                </CardHeader>
